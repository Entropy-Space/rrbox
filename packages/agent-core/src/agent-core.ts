...
export class AgentCore {
  ...
  constructor(options: AgentCoreOptions) {
    ...
    this.agent = new Agent({
      ...
      streamFn: createModelStreamFn(options.modelTransport),
