...
canonical session persistence, and `CoreEvent` projector. History-tree
navigation is deliberately unavailable for DSH sessions until DSH gains a
branch-aware session model.
