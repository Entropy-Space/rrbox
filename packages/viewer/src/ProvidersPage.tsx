...
export function ProvidersPage({
  ...
  const acceptSnapshot = (next: ProviderSettingsSnapshot) => {
    setSnapshot(next);
    onChanged(next);
  };
  ...
  return (
    <section className="providers-page" aria-labelledby="providers-page-title">
      ...
      <div className="provider-content">
        ...
        {loadError && (
          <div className="provider-page-message error" role="alert">
            {loadError}
          </div>
        )}
        ...
        {snapshot && editingProviderId !== null && (
          <ProviderEditor
        ...
        {snapshot && providers.length === 0 && editingProviderId === null && (
